...
public class PhoneAuthActivity extends RobicRufarm implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhoneNumberField = findViewById(R.id.editText);
        ...
        LoginButton loginButton = findViewById(R.id.fb_sigin);
